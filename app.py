...
st.write('# Handy Man :male-technologist: ')
st.write(""" Hey :wave: 
...
with st.sidebar:
    target_language = st.selectbox('Avaliable Languages', ['English', 'French', 'Italian', 'Japanese', 'Russian', 'Korean', 'Spanish'])
...
with t1:
    ...
    inp_text = st.text_input(" ", "Hello, I'm handyman", key=1)
